...
class NeRFSystem(LightningModule):
    def __init__(self, hparams):
        ...
        self.nerf_coarse = NeRF(D=self.hparams.D, W=self.hparams.W)
        self.models = [self.nerf_coarse]
        if hparams.N_importance > 0:
            self.nerf_fine = NeRF(D=self.hparams.D, W=self.hparams.W)
    ...
    def prepare_data(self):
        ...
        self.train_dataset = KlevrDataset(self.hparams.root_dir, split='train')
        self.val_dataset = KlevrDataset(self.hparams.root_dir, split='val')
